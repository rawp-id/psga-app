...
@section('content')
<div class="container">
    <h1>Manajemen Konsultasi Pengaduan</h1>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('admin.konsultasi-pengaduans.destroy', $k->id) }}" method="POST" style="display:inline;">
                        @csrf @method('DELETE')
                        ...
                        <form action="{{ route('admin.konsultasi-pengaduans.update', $k->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <select name="pengaduan_id" class="form-control" required>
                                ...
                                <div class="mb-3">
                                    <label>Link</label>
                                    <input type="text" name="link_konsultasi" value="{{ $k->link_konsultasi }}" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label>Status</label>
